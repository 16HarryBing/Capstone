...
<?php include('navfixed.php');?>
	...
	<div class="contentheader">
			<ul class="breadcrumb">
			<li class="active icon-table" style="font-size: 25px;"> Stock list</li>
			</ul>
<div id="maintable">
...
<form action="savepurchaseitem.php" method="post" >
...
<input type="number" name="qty" value="" placeholder="Qty" min="0"  autocomplete="off" style="width: 68px; height:30px; padding-top: 6px; padding-bottom: 6px; margin-right: 4px;" />
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			?>
			<tr>
				<td colspan="1"><strong style="font-size: 12px; color: #222222;">Total:</strong></td>
				...
				$sdsd=$_GET['iv'];
				$resultas = $db->prepare("SELECT sum(qty) FROM purchases_item WHERE invoice= :b");
