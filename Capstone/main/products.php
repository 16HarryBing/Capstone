...
<a rel="facebox" href="addproduct.php"><Button type="submit" class="btn btn-primary" style="float:right; width:150px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Product</button></a><br><br>
<a rel="facebox" href="addstock.php"><Button class="btn btn-primary " style="float:right; width:150px; height:35px;" /> Update Stock</button></a><br><br>
