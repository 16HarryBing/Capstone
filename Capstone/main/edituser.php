...
<span>Password : </span><input type="password" style="width:265px; height:30px;" name="password" autocomplete="off" />
<input type="hidden" style="width:265px; height:30px;" name="current_password" value="<?php echo $row['password']; ?>" autocomplete="off" />
<br>
<span>Position : </span>
