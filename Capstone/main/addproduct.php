...
<span>Date Arrival: </span><input type="date" style="width:265px; height:30px;" placeholder="09/13/2017" class="tcal tcalInput"  name="date_arrival" required ></input><br>
<span>Selling Price : </span><input type="number" id="txt1" style="width:265px; height:30px;" name="price" onkeyup="sum();"  autocomplete="off" Required><br>
<span>Original Price : </span><input type="number" id="txt2" style="width:265px; height:30px;" name="o_price" onkeyup="sum();" autocomplete="off" Required><br>
<span>Profit : </span><input type="number" id="txt3" min="0" style="width:265px; height:30px;" name="profit" readonly><br>
<span Required>Supplier : </span>
