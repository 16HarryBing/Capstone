...
<div class="container-fluid">
	...
	<div class="contentheader">
			...
			<ul class="breadcrumb">
			<li class="active icon-table"  style="font-size: 25px;"> Category</li>
			</ul>
...
<a rel="facebox" href="addcat.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Categories</button></a><br><br>
