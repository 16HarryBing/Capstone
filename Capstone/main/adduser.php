...
<hr>
        ...
        <?php } ?>
<div id="ac">
<span>Full Name : </span><input type="text" style="width:265px; height:30px;" name="name" placeholder="Full Name" value="<?php if(isset($_SESSION['name'])) echo $_SESSION['name']; ?>"  Required autocomplete="off" / ><br>
<span>Username : </span><input type="text" style="width:265px; height:30px;" name="username" placeholder="Username"value="<?php if(isset($_SESSION['username'])) echo $_SESSION['username']; ?>"  autocomplete="off" /><br>
...
<select name="position" style="width:265px; height:30px; margin-left:-5px;">
    <option value="" <?php if(!isset($_SESSION['position']) || $_SESSION['position'] == '') echo 'selected'; ?>>--</option>
