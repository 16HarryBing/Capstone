...
<center><strong>From : <input type="text" style="width: 223px; height:35px; color:#222;" name="t1" class="tcal" value="" autocomplete="off" / /> To: <input type="text" style="width: 223px; height:35px; color:#222;" name="t2" class="tcal" value=""autocomplete="off"/ />
