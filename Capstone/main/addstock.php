...
<span>Products: </span>
  ...
  <input type="number" name="qty" id="qty" value="" style="width:265px; height:30px; margin-left:-5px;"  readonly>
  <br>
  <span>Add Quantity: </span>
  <input type="number" name="new_qty" id="new_qty" style="width:265px; height:30px; margin-left:-5px;"  required>
  <br>
