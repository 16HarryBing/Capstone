...
{ 
  ...
  var docprint=window.open("","",disp_setting); 
   ...
   docprint.document.write('</head><body onLoad="self.print()" style="width: 800px; font-size:11px; font-family:arial; font-weight:normal;">');          
...
<div class="container-fluid">
      <div class="row-fluid">
			<ul class="breadcrumb">
			<li class="active icon-table"  style="font-size: 25px;" > Sales Invetory</li>
			</ul>
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
	<div style="float:right;">		
<button  style="float:center;" class="btn btn-success btn-mini"><a href="javascript:Clickheretoprint()"> Print</button></a>
</div>
<br>
<br>
<br>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<tr>
				...
				<?php
				$resultqty = $db->prepare("SELECT sum(qty) from sales_order");
				$resultqty->execute();
				for($i=0; $rowas = $resultqty->fetch(); $i++){
					$fgfg=$rowas['sum(qty)'];
					echo formatNumber($fgfg, true);
				}
				?>
				</strong></th>
				<th colspan="1"><strong style="font-size: 13px; color: #222222;">₱<?php
