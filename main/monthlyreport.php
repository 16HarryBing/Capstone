...
<div class="container-fluid">
	...
	<div class="contentheader">
			...
			<ul class="breadcrumb">
			<li class="active icon-bar-chart" style="font-size: 25px;"> Monthly Sales Report</li>
			</ul>
<br>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	if(isset($_POST['submit']))
	{
				...
				$current_day = date('m', strtotime($_POST['daily']));
    			$query = "SELECT DATE(date) AS date, Transaction_id as id, SUM(amount) AS amount, SUM(profit) AS profit FROM sales WHERE MONTH(date) = $current_day GROUP BY DATE(date) ORDER BY date";
